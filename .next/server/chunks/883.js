"use strict";exports.id=883,exports.ids=[883],exports.modules={32281:(e,i,t)=>{t.d(i,{Z:()=>d});var r=t(97247),o=t(28964),n=t(20579),a=t(30754),s=t(99219);function p(e){if("cv"===e.tipo)return"C"===e.gabarito?"CERTO":"E"===e.gabarito?"ERRADO":e.gabarito||"-";if("number"==typeof e.correct){let i=["A","B","C","D","E"][e.correct]??String(e.correct+1),t=e.options?.[e.correct];return t?`${i} - ${t}`:i}return e.gabarito||"-"}function c(e,i){return void 0!==i&&i===("cv"===e.tipo?e.gabarito??"":"number"==typeof e.correct?e.correct:null)}function d({questions:e,loading:i=!1,title:t="Quest\xf5es do tema",maxWidth:d=820,showEmptyState:m,onOpenManual:x,onGenerateAI:u}){let[g,f]=(0,o.useState)({}),[h,b]=(0,o.useState)({}),[q,v]=(0,o.useState)(!1);(0,o.useMemo)(()=>e.map((e,i)=>e.id??`${i}:${e.question}`).join("|"),[e]);let w=m??!!(x||u);if(i)return(0,r.jsxs)("div",{className:"iq-shell",style:{maxWidth:d,width:"100%"},children:[r.jsx(l,{}),(0,r.jsxs)("div",{className:"iq-loading",children:[r.jsx("div",{className:"iq-spinner"}),"Gerando quest\xf5es..."]})]});if(0===e.length)return w?(0,r.jsxs)("div",{className:"iq-shell",style:{maxWidth:d,width:"100%"},children:[r.jsx(l,{}),(0,r.jsxs)("div",{className:"iq-empty",children:[r.jsx("div",{className:"iq-empty-icon",children:r.jsx(n.Z,{size:22})}),r.jsx("div",{className:"iq-empty-title",children:"Nenhuma quest\xe3o gerada ainda"}),r.jsx("div",{className:"iq-empty-copy",children:"Crie quest\xf5es para praticar sem sair do resumo."}),(0,r.jsxs)("div",{className:"iq-empty-actions",children:[u&&(0,r.jsxs)("button",{className:"iq-primary-action",onClick:u,children:[r.jsx(a.Z,{size:15})," Gerar com IA"]}),x&&(0,r.jsxs)("button",{className:"iq-secondary-action",onClick:x,children:[r.jsx(s.Z,{size:15})," Criar manualmente"]})]})]})]}):null;let y=Object.keys(h).length,j=Object.entries(h).filter(([i,t])=>!!t&&c(e[Number(i)],g[Number(i)])).length,k=y>0?Math.round(j/y*100):0;return(0,r.jsxs)("section",{className:"iq-shell",style:{maxWidth:d,width:"100%"},children:[r.jsx(l,{}),(0,r.jsxs)("div",{className:"iq-header",children:[(0,r.jsxs)("div",{children:[r.jsx("div",{className:"iq-title",children:t}),(0,r.jsxs)("div",{className:"iq-count",children:[e.length," quest",1!==e.length?"\xf5es":"\xe3o"]})]}),(0,r.jsxs)("div",{className:"iq-header-actions iq-screen-control",children:[x&&(0,r.jsxs)("button",{className:"iq-secondary-action iq-compact-action",onClick:x,children:[r.jsx(s.Z,{size:14})," Nova quest\xe3o"]}),u&&(0,r.jsxs)("button",{className:"iq-primary-action iq-compact-action",onClick:u,children:[r.jsx(a.Z,{size:14})," Gerar"]})]})]}),y>0&&(0,r.jsxs)("div",{className:"iq-score iq-screen-control",children:[(0,r.jsxs)("div",{className:"iq-score-value",style:{color:k>=70?"#10b981":k>=50?"#f59e0b":"#ef4444"},children:[k,"%"]}),(0,r.jsxs)("div",{children:[(0,r.jsxs)("div",{className:"iq-score-main",children:[j," de ",y," corretas"]}),r.jsx("div",{className:"iq-score-sub",children:e.length-y>0?`${e.length-y} ainda n\xe3o respondida(s)`:"Todas respondidas"})]})]}),r.jsx("div",{className:"iq-list",children:e.map((e,i)=>{let t=void 0!==g[i],o=!!h[i],n=c(e,g[i]);return(0,r.jsxs)("article",{className:"iq-card",children:[(0,r.jsxs)("div",{className:"iq-card-header",children:[(0,r.jsxs)("div",{className:"iq-card-meta",children:[(0,r.jsxs)("span",{className:"iq-number",children:["Q",i+1]}),r.jsx("span",{className:"cv"===e.tipo?"iq-badge iq-badge-cv":"iq-badge iq-badge-mc",children:"cv"===e.tipo?"Certo / Errado":"M\xfaltipla escolha"})]}),e.banca&&r.jsx("span",{className:"iq-bank",children:e.banca})]}),r.jsx("div",{className:"iq-question-text",children:e.question}),"cv"===e.tipo?r.jsx("div",{className:"iq-cv-options",children:["C","E"].map(t=>{let n=g[i]===t,a=t===e.gabarito,s=o?a?"iq-option-correct":n?"iq-option-wrong":"":n?"iq-option-selected":"";return r.jsx("button",{className:`iq-option-button ${s}`,onClick:()=>!o&&f(e=>({...e,[i]:t})),disabled:o,children:"C"===t?"Certo":"Errado"},t)})}):r.jsx("div",{className:"iq-mc-options",children:(e.options??[]).map((t,n)=>{let a=g[i]===n,s=n===e.correct,p=o?s?"iq-option-correct":a?"iq-option-wrong":"":a?"iq-option-selected":"";return(0,r.jsxs)("button",{className:`iq-option-button iq-mc-option ${p}`,onClick:()=>!o&&f(e=>({...e,[i]:n})),disabled:o,children:[r.jsx("span",{className:"iq-option-letter",children:["A","B","C","D","E"][n]}),r.jsx("span",{children:t})]},n)})}),o?(0,r.jsxs)("div",{className:n?"iq-feedback iq-feedback-correct iq-screen-control":"iq-feedback iq-feedback-wrong iq-screen-control",children:[r.jsx("div",{className:"iq-feedback-title",children:n?"Resposta correta":"Resposta incorreta"}),r.jsx("div",{className:"iq-feedback-copy",children:e.explanation||`Gabarito: ${p(e)}`})]}):r.jsx("button",{className:"iq-confirm iq-screen-control",onClick:()=>t&&b(e=>({...e,[i]:!0})),disabled:!t,children:"Confirmar resposta"}),(0,r.jsxs)("div",{className:"iq-print-answer",children:[r.jsx("strong",{children:"Gabarito:"})," ",p(e),e.explanation&&(0,r.jsxs)("div",{children:[r.jsx("strong",{children:"Explica\xe7\xe3o:"})," ",e.explanation]})]})]},e.id??i)})}),(0,r.jsxs)("div",{className:"iq-gabarito iq-screen-control",children:[r.jsx("button",{className:"iq-gabarito-toggle",onClick:()=>v(e=>!e),children:q?"Ocultar gabarito":"Ver gabarito"}),q&&r.jsx("div",{className:"iq-gabarito-list",children:e.map((e,i)=>(0,r.jsxs)("div",{className:"iq-gabarito-row",children:[(0,r.jsxs)("span",{className:"iq-gabarito-index",children:["Q",i+1]}),r.jsx("span",{className:"iq-gabarito-answer",children:p(e)})]},e.id??i))})]})]})}function l(){return r.jsx("style",{children:`
      .iq-shell {
